...
impl TypstEngine {
    ...
    pub async fn reconstruct_pdf(
        ...
        tracing::info!("[typst_engine] Subsetting fonts for reconstructed document ({} transactions)", statement.transactions.len());
        ...
        match out {
            ...
            Err(e) => {
                ...
                tracing::warn!("[typst_engine] Typst CLI not found, saving .typ file only: {}", e);
