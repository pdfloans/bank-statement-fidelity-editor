...
- **GCS buckets**
  - `gs://esoteric-energy-495909-t7-docai-training/` — bucket bound to the existing dataset
...
3. Source: `gs://esoteric-energy-495909-t7-docai-training/au-bank-statements-split/`
