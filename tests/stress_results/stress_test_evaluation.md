...
**Executed:** 2026-07-13 11:20:08 UTC
...
|---|---|---|---|---|---|---|
| 1 | **LlamaParse** | 100 | 96 | **98.0** | 13173ms | Found 30/30 txn lines in markdown |
| 2 | **Offline Heuristic** | 88 | 98 | **93.0** | 26ms | Found 25/30 txns, closing=Y |
| 3 | **PyMuPDF Built-in** | 0 | 95 | **47.5** | 199ms | Found 0/30 txns, 0 decimal errors |
| 4 | **Mindee API** | 0 | 0 | **0.0** | 0ms | API key not configured |
...
| Rank | Tool | Correctness | Fidelity | Avg | Latency | Details |
|---|---|---|---|---|---|---|
| 1 | **pymupdfpro** | 90 | 85 | **87.5** | 218ms | Found 18 '7' glyphs, 18 successful edits, restored=Y |
| 2 | **Pdfium** | 60 | 92 | **76.0** | 1309ms | Rendered 2480x3509px @ 300DPI, content=Y |
| 3 | **Typst Reconstruct** | 75 | 65 | **70.0** | 33ms | 26/26 spans extractable, 1 fonts: {'Helvetica'} |

### Test 3: Math Balance

| Rank | Tool | Correctness | Fidelity | Avg | Latency | Details |
|---|---|---|---|---|---|---|
| 1 | **Local Math Engine** | 100 | 100 | **100.0** | 20ms | Detected discrepancy=$45.0, opening=$5,000.00, closing=$10,850.21 |
...
| 5 | **Gemini AI** | 0 | 0 | **0.0** | 1731ms | HTTP 400: {
  "error": {
    "code": 400,
...
| Rank | Tool | Correctness | Fidelity | Avg | Latency | Details |
|---|---|---|---|---|---|---|
| 1 | **SSIM + Tile-Max + pHash** | 100 | 100 | **100.0** | 35856ms | SSIM≈0.997970, max_tile=0.583347, diff_px=72852, region_detect=Y |
| 2 | **pdfRest Cloud** | 75 | 98 | **86.5** | 6767ms | Adobe-tier render at 300DPI, manual diff required |
| 3 | **Applitools Eyes** | 40 | 100 | **70.0** | 10950ms | Visual AI diff=MISSED, output_len=111 |
| 4 | **Gemini Vision** | 0 | 0 | **0.0** | 8273ms | HTTP 400 |
