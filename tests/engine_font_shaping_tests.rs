use dual_core_pdf_pipeline::engine::font_shaping::{calculate_exact_width, extract_and_measure_width};
...
fn test_extract_and_measure_width() {
    ...
    let content_id = doc.add_object(Stream::new(dictionary! {}, Content { operations: vec![
        ...
        Operation::new("Tj", vec![Object::String("Hello".into(), StringFormat::Literal)]),
